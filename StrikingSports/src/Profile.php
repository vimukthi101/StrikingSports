        ...
        <div style="padding:10px;"> 
			<form role="form" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                    	<input class="form-control" type="text" name="nic" id="nic" readonly="readonly" value="<?php echo $email; ?>"/>
                	</div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group text-center">
                    <label class="control-label col-md-4"><a href="changePassword.php">Change Password</a></label>
                    <label class="control-label col-md-4"><a href="editProfile.php">Update Profile</a></label>
                </div>
            </form>
        </div>    
    </div>
