        ...
        <div style="padding:10px;"> 
			<form role="form" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                    	<input class="form-control" type="text" name="nic" id="nic" readonly value="<?php echo $position;?>"/>
                	</div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group text-center">
                    <label class="control-label col-md-4"><a href="changeStaffPassword.php">Change Password</a></label>
                    <label class="control-label col-md-4"><a href="editStaffProfile.php">Update Profile</a></label>
                </div>
            </form>
        </div>    
    </div>
